...
function IconPreview({ iconName, iconPackage, className }: IconPreviewProps) {
    ...
    const isReady =
        loaded?.name === iconName && loaded?.pack === iconPackage
                            ...
                            <CommandEmpty>
                                {searchQuery ? (
                                    ...
                                    <div className="flex flex-col items-center gap-1.5 py-8">
                                        ...
                                        <p className="max-w-[200px] text-xs text-muted-foreground text-pretty">
                                            Type to search across{" "}
                                            {Object.keys(PACK_LOADERS).length}{" "}
                                            icon packs
                                        </p>
                                    </div>
                                )}
