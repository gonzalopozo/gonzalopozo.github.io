...
const PROJECT_STATUS_BADGE_VARIANTS: Record<
	ProjectStatus,
...
export function ProjectGridItemContent({
	...
	return (
		...
		>
			<figure
				className={cn(
					'relative min-h-[13rem] overflow-hidden border-b border-border/60 bg-secondary/40',
					{
			...
			<div className="flex h-full min-h-0 flex-col py-6">
				<CardHeader className="content-start items-start gap-4">
					...
					<div className="space-y-2">
						<CardTitle
							className={cn('text-balance tracking-tight', {
				...
				<CardFooter className="mt-auto flex flex-wrap items-center justify-between gap-3 border-t border-border/60 pt-4">
